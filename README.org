...
- [[https://github.com/sh-ow/vhdl-capf][VDHL capf]] :: emacs completion at point function (capf) for vhdl-mode

For an example, see my personal [[http://csantosb.pw:5003/emacs.cat/org-config.cat/csb-vhdl][config]].
